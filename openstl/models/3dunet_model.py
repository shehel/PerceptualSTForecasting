...
class 3DUNet_Model(nn.Module):
    ...
    def __init__(
        ...
        super(3DUNet_Model, self).__init__()
...
class Block(nn.Module):
    def __init__(self, dim, dim_out):
        ...
        self.norm = nn.BatchNorm3d(dim_out)
#
...
class UNetUpBlock(nn.Module):
    def __init__(self, in_size, out_size, up_mode, padding, batch_norm, time_emb_dim: Optional[int] = None,):
        ...
        if up_mode == "upconv":
            ...
            self.up = nn.Sequential(nn.Upsample(mode="trilinear", scale_factor=(1,2,2)), nn.Conv3d(in_size, out_size, kernel_size=1),)
