...
def create_parser():
    ...
    # dataset parameters
    parser.add_argument('--batch_size', '-b', default=2, type=int, help='Training batch size')
    parser.add_argument('--val_batch_size', '-vb', default=2, type=int, help='Validation batch size')
